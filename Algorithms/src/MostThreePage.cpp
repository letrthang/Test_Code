...
int main_most3()
{
	...
	Record r1, r2, r3, r4;
	r1.user_id = 1; r1.page_id =1;
	records.push_back(r1);
	r1.user_id = 1; r1.page_id =2;
	records.push_back(r1);
	r1.user_id = 1; r1.page_id =3;
	records.push_back(r1);

	r2.user_id = 2; r2.page_id =1;
	records.push_back(r2);
	r2.user_id = 2; r2.page_id =2;
	records.push_back(r2);
	r2.user_id = 2; r2.page_id =3;
	records.push_back(r2);

	r3.user_id = 3; r3.page_id =4;
	records.push_back(r3);
	r3.user_id = 3; r3.page_id =5;
	records.push_back(r3);
	r3.user_id = 3; r3.page_id =6;
	records.push_back(r3);

	r4.user_id = 4; r4.page_id =7;
	records.push_back(r4);
	r4.user_id = 4; r4.page_id =8;
	records.push_back(r4);
	r4.user_id = 4; r4.page_id =9;
	records.push_back(r4);
